...
import { extractDataFromXML } from '../Utils/HelperFunctions';
...
export default class Chart extends Component {
  ...
  componentDidMount() {
    ...
    let chartSettingsDefaultData = extractDataFromXML({ firstKey: 'view', secondKey: 'chart', xml: this.props.viewXML });
