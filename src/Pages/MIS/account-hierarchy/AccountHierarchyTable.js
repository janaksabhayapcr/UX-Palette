...
function getINITIAL_STATE(that) {
    ...
    return {
        ...
        data: [
            {
                superHouse: 'ABLA',
                household: 'Anne Black',
                taxEntity: 'Anne Black',
                custodian: 'Charles Schwab Advisor Services',
                account: '1648-7536',
                accountStatus: 'Active',
                loaReceived: 'False	',
                openTradeDate: '3/31/2017',
            },
            {
                superHouse: 'ABLA2',
                household: 'Anne Black',
                taxEntity: 'Ann Berman',
                custodian: 'Charles Schwab Advisor Services',
                account: '1648-7536',
                accountStatus: 'Active',
                loaReceived: 'False	',
        ...
        columns: [
            ...
            },
            {
                ...
                width: '20%',
                Cell: (row) => {
                    return <NavLink to={pageRoutes.account_summery}>{row.value}</NavLink>
                }
            },
            {
            ...
            {
                accessor: 'loaReceived',
                Header: 'loaReceived',
                width: '20%',
            },
            {
                accessor: 'openTradeDate',
                Header: 'openTradeDate',
                width: '20%',
            },
        ],
        loading: false,
...
export default class AccountHierarchyTable extends Component {
    ...
    searchGenericExport = async (filters, exportGrid, exportPreferences = null) => {
        ...
        // page = 0;
        // pagesize = 1;
        // let { count } = await AccountModels.getAccountsGrid({
        //   user,
        //   services,
        //   filter,
        //   orderby,
        ...
        //   response = await AccountModels.getAccountsGrid({
        //     user,
        //     services,
        //     filter,
        //     orderby,
            ...
            <div className="myenrollments-wrapper">
                ...
                <div className="header-myenrollments">
                    <div className="myenrollments-title">
                        ...
                        {enrollHomeTitle ? enrollHomeTitle : 'Account Hierarchy'}
              ...
              />
                    ...
                    <div className="generic-button-wrapper">{/* other buttons */}</div>
                </div>

                <div className="subheader-myenrollments">
                    <div className="myenrollments-account-search-wrapper">
                        <div className='search--input'>
                            <input
                                className="myenrollments-account-search"
                                id="account-search-text-input"
                                title="Search Full Account or Token"
                                placeholder="Search ..."
                            ...
                            <FontAwesome
                                name="xbutton"
                                className="fa-times fa-times-clear myenrollments-clear-search"
                                onClick={() => {
                                    this.onSearchTextChange({ target: { value: '' } });
                                }}
                            />
                        </div>

                        <div className="myenrollments-quickfilter-div mw-100">
                            <div className="quickfilter-buttons-div">
                                {enhancedNavigation && <div className="quickfilter-add-filters-myenrollments">Add filters:</div>}
                                <div
                                    id="status-quickfilter"
                                    className={handleEnhancedNav(quickfilters.indexOf('ActiveAccounts') === -1, enhancedNavigation)}
                                    onClick={() => {
                        ...
                        {/* {!enrollment_anonymized && (
                            <div id="detokenize-current-view" className="download-account-custom-div">
                                <button
                                    onClick={() => {
                                        this.setTokenFilter();
                                    }}
                                ...
                                >
                                    <ReactTooltip delayShow={globals.TOOLTIP_DELAY} id="eyeball-info" place="top" type="info" effect="solid" className="tooltip_custom">
                                        <p>{tokenFilter ? 'Show Account Information' : 'Hide Account Information'}</p>
                                    </ReactTooltip>
                                    <FontAwesome
                                        name={tokenFilter ? 'far fa-eye myenrollments-account-eye' : 'far fa-eye-slash myenrollments-account-eye'}
                        ...
                        {EnrollmentDownloadable && (
                            <div
                                id="download-current-view"
                                onClick={() => {
                                    //this.downloadCurrentView();
                                    this.setState({ export_pref_open: true });
                                }}
                                className="download-account-custom-div"
                            >
                                <ReactTooltip delayShow={globals.TOOLTIP_DELAY} id="download-info" place="top" type="info" effect="solid" className="tooltip_custom">
                                    <p>Download Account Information</p>
                                </ReactTooltip>
                                {this.state.exporting ? (
                                    <div title="Preparing export. Please do not navigate away from this PowerGrid.">
                                        <i className="fa fa-spinner fa-spin std-export-spinner"></i>
                                    </div>
                                ) : (
                                    <FontAwesome name="fas fa-download" data-for="download-info" data-tip className="fa fas fa-download download-account" />
                                )}
                            </div>
                        )}
                    </div>
