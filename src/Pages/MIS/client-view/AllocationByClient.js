...
function getINITIAL_STATE(that) {
  ...
  return {
    ...
    data: [
      {
        clientType: 'Custodian A',
        amount: 10000,
        percentage: 50,
      },
      {
        clientType: 'Custodian B',
        amount: 7500,
        percentage: 37.5,
      },
      {
        clientType: 'Custodian C',
        amount: 2500,
        percentage: 12.5,
      },
      {
...
export default class AllocationByClient extends Component {
          ...
          <div className="myenrollments-wrapper">
            ...
            <div className="header-myenrollments">
              <div className="myenrollments-title">
                ...
                {enrollHomeTitle ? enrollHomeTitle : 'Allocation By Client'}
              </div>
