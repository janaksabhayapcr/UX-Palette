...
function getINITIAL_STATE(that) {
    ...
    return {
        ...
        data: [
            { custodian: 'custodian', home: 'home', away: 'away', total: 'total' },
            { custodian: 'custodian', home: 'home', away: 'away', total: 'total' },
            { custodian: 'custodian', home: 'home', away: 'away', total: 'total' },
            { custodian: 'custodian', home: 'home', away: 'away', total: 'total' },
            { custodian: 'custodian', home: 'home', away: 'away', total: 'total' },
...
export default class AllocationByCustodianTable extends Component {
                    ...
                    <div className="myenrollments-wrapper">
                        ...
                        <div className="header-myenrollments">
                            <div className="myenrollments-title">
                                ...
                                {enrollHomeTitle ? enrollHomeTitle : 'Allocation By Custodian'}
                            </div>
