...
function getINITIAL_STATE(that) {
    ...
    return {
        ...
        data: [
            { managerType: 'managerType', amount: 'amount', percentage: 'percentage'  },
            { managerType: 'managerType', amount: 'amount', percentage: 'percentage' },
            { managerType: 'managerType', amount: 'amount', percentage: 'percentage' },
            { managerType: 'managerType', amount: 'amount', percentage: 'percentage' },
            { managerType: 'managerType', amount: 'amount', percentage: 'percentage' },
...
export default class AllocationByManagerTable extends Component {
                    ...
                    <div className="myenrollments-wrapper">
                        ...
                        <div className="header-myenrollments">
                            <div className="myenrollments-title">
                                ...
                                {enrollHomeTitle ? enrollHomeTitle : 'Allocation By Manager'}
                            </div>
