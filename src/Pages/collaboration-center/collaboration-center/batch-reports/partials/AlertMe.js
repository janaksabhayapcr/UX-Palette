...
const AlertMe = ({ isOpen, onClose, onSave }) => {
    return (
        <Modal
            title="silverman Batch Reports - New Alert"
            isOpen={isOpen}
            onClose={onClose}
            ...
            <Table bordered className="modal--table mb-0">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text" name="" id="" className='w-100' value="Silver Batch Report: Ann Berman TaxEntity.pdf" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span className="d-block mb-1 text-capitalize">Items are deleted</span>
                            <p className="mb-0 text-capitalize"> Specify the type of changes that you want to be alerted to.</p>
                        </td>
                        <td>
                            <td>
                                <div className="px-2">
                                    <span className="d-block mb-1 text-capitalize"> Only send me alerts when:
                                    </span>
                                    <div>
                                        <div >
                                            <label className='me-2' htmlFor='changes'>
                                                <input type="radio" name="changeType" id="changes" className='me-2' checked/> All changes
                                            </label>
                                        </div>
                                        <div >
                                            <label className='me-2' htmlFor='items'>
                                                <input type="radio" name="changeType" id="items" className='me-2' /> New items are added
                                            </label>
                                        </div>
                                        <div >
                                            <label className='me-2' htmlFor='modified'>
                                                <input type="radio" name="changeType" id="modified" className='me-2' /> Existing items are modified
                                            </label>
                                        </div>
                                        <div >
                                            <label className='me-2' htmlFor='deleted'>
                                                <input type="radio" name="changeType" id="deleted" className='me-2' /> Items are deleted
                                            </label>
                                        </div>
