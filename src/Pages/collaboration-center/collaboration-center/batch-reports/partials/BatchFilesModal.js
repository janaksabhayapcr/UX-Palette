...
const BatchFilesModal = ({ isOpen, onClose, onSave, isEdit, setIsEdit }) => {
                                                ...
                                                <div className='d-flex '>
                                                    ...
                                                    <div className='px-2'>
                                                        <ul className='action-ul list-unstyled mb-0'>
                                                            <li className='disabled-link d-flex align-items-center'> <FontAwesome className="fa-solid fa me-2 fa-eye"></FontAwesome>  <span className="d-block mb-1 text-capitalize">  version history</span></li>
