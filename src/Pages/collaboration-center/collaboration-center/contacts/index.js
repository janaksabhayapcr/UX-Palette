...
import AddContactsModal from './partials/AddContactsModal'
...
const Contacts = () => {
    ...
    return (
        <>
            ...
            <AddContactsModal isOpen={isOpenModal} onClose={() => setIsOpenModal(false)} onSave={() => { setIsOpenModal(false) }} isEdit={true} />
