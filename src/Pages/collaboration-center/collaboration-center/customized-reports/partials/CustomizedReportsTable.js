...
import AddCustomizedReportsModal from './AddCustomizedReportsModal';
import AlertMe from './AlertMe';

export default function CustomizedReportsTable() {
    ...
    return (
        <div className="myenrollments-wrapper">
            ...
            <AddCustomizedReportsModal isOpen={isOpenModal} onClose={() => setIsOpenModal(false)} onSave={() => { setIsOpenModal(false) }} isEdit={isEdit} setIsEdit={setIsEdit} />
