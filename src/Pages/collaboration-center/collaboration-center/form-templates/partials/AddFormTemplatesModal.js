...
const AddFormTemplatesModal = ({ isOpen, onClose, onSave, isEdit, setIsEdit }) => {
  ...
  return (
    <>
      <Modal
        title="Form Template - 2012.10.15"
        isOpen={isOpen}
        onClose={onClose}
      ...
      >
        ...
        <Table bordered className="modal--table mb-0">
          <tbody>
              ...
              <td>
                {
                  !isEdit ?
                    ...
                    :
                    <div>
                      <input type="text" className="mb-2" />.pdf
                    </div>
                }
              </td>
            </tr>
            ...
            <tr>
              <td>
                <span className="d-block mb-1 text-capitalize">Form Name</span>
              </td>
              <td>
                {
                  !isEdit ?
            ...
            <tr>
              <td>
                <span className="d-block mb-1 text-capitalize">Form Category</span>
              </td>
              <td>
                {
                  !isEdit ?
            ...
            <tr>
              <td>
                <span className="d-block mb-1 text-capitalize">Form ID
                </span>
              </td>
              <td>
                {
            ...
            <tr>
              <td>
                <span className="d-block mb-1 text-capitalize">Form Locale
            ...
            <tr>
              <td>
                <span className="d-block mb-1 text-capitalize">Form Description
            ...
            <tr>
              <td>
                <span className="d-block mb-1 text-capitalize">Show in Catalog
              ...
              <td>
                {
                  !isEdit ?
                    <span className="d-block mb-1 text-capitalize"> yes </span>
                    :
                    <div>
                      <input type="checkbox" />
                    </div>
...
export default AddFormTemplatesModal;
