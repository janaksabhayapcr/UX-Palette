...
import AddFormTemplatesModal from './AddFormTemplatesModal';
...
export default function FormTemplatesTable() {
                        ...
                        <div className="action--tooltip">
                            ...
                            <div className="action--tooltip--text">
                                <ul className='list-unstyled'>
                                    ...
                                    <li className='text-start text-capitalize'><span>alert me</span></li>
        ...
        data: [
            {
                type: 'folder',
                name: '2012.10.15',
                formName: '10/15/2012 6:56 AM',
                formDes: 'System Account',
            },
            {
                type: 'folder',
                name: '2012.10.15',
    ...
    return (
        <div className="myenrollments-wrapper">
            ...
            <AddFormTemplatesModal isOpen={isOpenModal} onClose={() => setIsOpenModal(false)} onSave={() => { setIsOpenModal(false) }} isEdit={isEdit} setIsEdit={setIsEdit} />
