...
import AddLoasModal from './AddLoasModal';

export default function LoasTable() {
  ...
  return (
    <div className="myenrollments-wrapper">
      ...
      <AddLoasModal isOpen={isOpenModal} onClose={() => setIsOpenModal(false)} onSave={() => { setIsOpenModal(false) }} isEdit={isEdit} setIsEdit={setIsEdit} />
