...
const LetterAuthorizationStatusTable = ({ parentState, parentChangeState }) => {
      ...
      <Table className="mb-0 text-start">
        <thead>
          <tr>
            ...
            <th className="text-capitalize">State / SH / Received</th>
...
export default LetterAuthorizationStatusTable;
