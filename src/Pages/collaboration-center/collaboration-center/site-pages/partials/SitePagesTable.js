...
export default function SitePagesTable() {
    ...
    return (
        <div className="myenrollments-wrapper">
            ...
            <AddDocumentModal isOpen={isOpenModal} onClose={() => setIsOpenModal(false)} onSave={() => { setIsOpenModal(false) }} isEdit={isEdit} setIsEdit={setIsEdit} />
