...
const AddStatementsModal = ({ isOpen, onClose, onSave, isEdit, setIsEdit }) => {
            ...
            >
                ...
                <Table bordered className="modal--table mb-0">
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <span className="d-block mb-1 text-capitalize">Account </span>
                            </td>
                            <td>
                                {
                                    !isEdit ? <p className="d-block mb-1 text-capitalize"> </p> :
                        ...
                        <tr>
                            <td>
                                <span className="d-block mb-1 text-capitalize">Statement Date </span>
                            </td>
                            <td>
                                {
                                    !isEdit ? <p className="d-block mb-1 text-capitalize"> </p> :
                        ...
                        <tr>
                            <td>
                                <span className="d-block mb-1 text-capitalize">Custodian </span>
                            </td>
                            <td>
                                {
                                    !isEdit ? <p className="d-block mb-1 text-capitalize"> </p> :
                        ...
                        <tr>
                            <td>
                                <span className="d-block mb-1 text-capitalize">Tax Entity </span>
                            </td>
                            <td>
                                {
                                    !isEdit ? <p className="d-block mb-1 text-capitalize"> </p> :
                ...
                {!isEdit &&
                    <div className='modal--footer--content'>
                        <div className='mt-2'><span>Created at 5/9/2024 5:11 AM by <Link to="#" className="text-decoration-none text-black">PCR TestNo presence information</Link></span ></div >
...
export default AddStatementsModal;
