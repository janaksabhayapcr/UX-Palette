...
import AddStatementsModal from './AddStatementsModal';
...
export default function StatementsTable() {
    ...
    data: [
      {
        ...
        statementDate: '10/15/2012 6:56 AM',
        custodian: 'System Account',
        taxEntity: 'System Account',
      },
      {
        type: 'folder',
        name: '2012.10.15',
  ...
  return (
    <div className="myenrollments-wrapper">
      ...
      <AddStatementsModal isOpen={isOpenModal} onClose={() => setIsOpenModal(false)} onSave={() => { setIsOpenModal(false) }} isEdit={isEdit} setIsEdit={setIsEdit} />
