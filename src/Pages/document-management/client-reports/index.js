...
import ClientReportsTable from './partials/ClientReportsTable';
import AddDocumentModal from '../partials/AddDocumentModal';
import DocumentsModal from './partials/DocumentsModal';
...
const ClientReports = () => {
  ...
  return (
    <>
        ...
        <Container fluid>
          <Card>
            ...
            <Card.Body as="div">
              <Row>
                <Col xxl={6}>
                  <ClientReportsTable user={user} services={services} crmData={crmData} />
                </Col>
                <Col xxl={6}></Col>
              </Row>
            </Card.Body>
      ...
      <DocumentsModal isOpen={documentModal} onClose={() => setDocumentModal(false)} onSave={() => setDocumentModal(false)} />
    </>
  );
};
