...
function getINITIAL_STATE(that) {
  ...
  return {
    ...
    columns: [
      ...
      {
        accessor: 'reportPeriodStart',
        Header: 'Report Period Start',
        width: '25%',
      },
      {
        accessor: 'reportPeriodEnd',
...
export default class ExtendedReportDataTable extends Component {
  ...
  render() {
    ...
    return (
      <div className="myenrollments-wrapper">
        ...
        {/* <div className="header-myenrollments mb-3">
          <div className="myenrollments-title">
            ...
            {enrollHomeTitle ? enrollHomeTitle : 'Report Status'}
          </div>
          <div className="generic-button-wrapper"></div>
        </div> */}
