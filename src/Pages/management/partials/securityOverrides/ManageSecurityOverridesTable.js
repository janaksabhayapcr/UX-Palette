...
function getINITIAL_STATE(that) {
  ...
  return {
    ...
    columns: [
      {
        Header: 'Default Security Master Configuration',
        columns: [
          { Header: 'Edit', accessor: 'edit' },
          { Header: 'Delete', accessor: 'delete' },
          { Header: 'Name Text', accessor: 'nameText' },
          { Header: 'System ID', accessor: 'System_ID' },
          { Header: 'CUSIP', accessor: 'cusip' },
          { Header: 'Asset Style', accessor: 'Asset_Style' },
          { Header: 'Sector', accessor: 'sector' },
        ],
      },
      {
        Header: 'Offit Capital Security Master Overrides',
        columns: [
          { Header: 'Custom Name Text', accessor: 'Custom_Name_Text' },
          { Header: 'Asset Style', accessor: 'Asset_Style' },
          { Header: 'Sector', accessor: 'sector' },
          { Header: 'Region', accessor: 'Region' },
          { Header: 'Currency', accessor: 'Currency' },
          { Header: 'Modified By', accessor: 'Modified_By' },
...
export default class ManageSecurityOverridesTable extends Component {
  ...
  exportGrid = async (exportPreferences = null) => {
    ...
    await this.searchGenericExport('', true, exportPreferences).then((res) => {
      ...
      let fileNameCaption = enrollHomeTitle ? enrollHomeTitle : 'Manage Security Overrides';
      downloadCSVFormatted({
        data: res,
      ...
      <div className="myenrollments-wrapper">
        ...
        <div className="header-myenrollments">
          <div className="myenrollments-title">
            ...
            {enrollHomeTitle ? enrollHomeTitle : 'Manage Security Overrides'}
          </div>
        ...
        <div className="subheader-myenrollments">
          <div className="myenrollments-account-search-wrapper">
            ...
            <div className="myenrollments-quickfilter-div">
