...
export default class OpenTaskTable extends Component {
      ...
      <div className="myenrollments-wrapper">
        ...
        <div className="header-myenrollments">
          <div className="myenrollments-title">
            ...
            {enrollHomeTitle ? enrollHomeTitle : 'My Open Task'}
        ...
        <div className="subheader-myenrollments">
          <div className="myenrollments-account-search-wrapper">
            ...
            <button
              type="button"
              className="d-block text-capitalize dynamic--button me-2 d-block global--btn-css border-0 btn btn-primary btn-sm"
              onClick={() => {
                this.setState((prev) => ({
                  ...prev,
                  isTasksNewItemModalOpen: true,
                }));
              }}
            >
              Add New Task
        ...
        <AddNewTaskModal
          isOpen={this.state.isTasksNewItemModalOpen}
          onClose={() => {
            this.setState((prev) => ({
              ...prev,
              isTasksNewItemModalOpen: false,
            }));
          }}
          onSave={() => {
            this.setState((prev) => ({
