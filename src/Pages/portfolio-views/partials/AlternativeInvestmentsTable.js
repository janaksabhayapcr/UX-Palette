...
function getINITIAL_STATE(that) {
  ...
  return {
    ...
    columns: [
      ...
      {
        accessor: 'actualMarketValue',
        Header: 'Actual Market Value',
        width: '20%',
      },
      {
        accessor: 'committedCapital',
        Header: 'Committed Capital',
        width: '20%',
      },
      {
        accessor: 'contributedCapital',
        Header: 'Contributed Capital',
        width: '20%',
      },
      {
        accessor: 'remainingCommitment',
...
export default class AlternativeInvestmentsTable extends Component {
