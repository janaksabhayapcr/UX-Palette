...
import { getCookie, isToken, setPolicyBoolean, checkPolicy, checkIfHome, downloadCSVFormatted, formatValue } from '../../../Components/Utils/HelperFunctions';
...
export default class YearToDateTransactionsTable extends Component {
    ...
    return (
      <div className="myenrollments-wrapper">
        ...
        <div className="subheader-myenrollments">
          <div className="myenrollments-account-search-wrapper justify-content-end mt-0">
