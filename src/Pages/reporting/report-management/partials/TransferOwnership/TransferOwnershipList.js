...
export default class TransferOwnershipList extends Component {
    ...
    return (
      <div className="myenrollments-wrapper">
        <div className="subheader-myenrollments">
          <div className="myenrollments-account-search-wrapper justify-content-between mt-0">
            <div className="d-flex align-items-center gap-2">
              <span className="d-block text-nowrap text-capitalize">login type</span>
              <ReactSelect options={[{}]} />
            </div>
